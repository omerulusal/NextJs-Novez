...
const Page = async () => {
    ...
    const res = await fetch(`https://api.themoviedb.org/3/movie/${category}?api_key=152011077666d008909e696b7a81f12c&language=en-US&page=1`,
        options
    )
    const data = await res.json()//gelen veriler jsona cevrilir
